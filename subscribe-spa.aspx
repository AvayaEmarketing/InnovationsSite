        ...
        <div class="container">
            <div class="span12">
                ...
                <div class="span6 hidden-phone">
                    <ul>
                        <li><a href="spanish.html?lang=ESP">Espa&#241;ol</a></li>
                        <li><a href="english.html?lang=ENG">Ingl&eacute;s</a></li>
                        <li><a href="portuguese.html?lang=POR">Portugu&eacute;s</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="row-fluid contphone">
        <div class="container">
            <div class="span12 tittlelang">
                <div class="span10 substitle"><h2>Suscribirse</h2></div>
            ...
            <div class="textsubs">
                ...
                <div class="form-horizontal">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="fistname">Nombre<span style="color: #cc0000;">*</span></label>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="lastname">Apellido<span style="color: #cc0000;">*</span></label>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="company">Empresa<span style="color: #cc0000;">*</span></label>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="company">Pa&iacute;s<span style="color: #cc0000;">*</span></label>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="company">&#191;Cu&aacute;ntos empleados tiene su empresa?<span style="color: #cc0000;">*</span></label>
