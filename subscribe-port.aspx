            ...
            <div class="span12">
                ...
                <div class="span6 hidden-phone">
                    <ul>
                        ...
                        <li><a href="english.html?lang=ENG">Ingl&ecirc;s</a></li>
                        <li><a href="portuguese.html?lang=POR">Portugu&ecirc;s</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="row-fluid contphone">
        <div class="container">
            <div class="span12 tittlelang">
                <div class="span10 substitle"><h2>Assinar</h2></div>
            ...
            <div class="textsubs">
                ...
                <div class="form-horizontal">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="fistname">Nome<span style="color: #cc0000;">*</span></label>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="lastname">Sobrenome<span style="color: #cc0000;">*</span></label>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="company">Pais<span style="color: #cc0000;">*</span></label>
                                <div class="controls">
